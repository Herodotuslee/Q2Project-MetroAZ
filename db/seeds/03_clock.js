  ...
  return knex('clock').del()
    .then(function () {
      ...
      return knex('clock').insert([
        ...
        {employee_id: 1,clockout_time:"15:00",clockin_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-20'},
        {employee_id: 1,clockout_time:"15:00",clockin_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-21'},
        {employee_id: 1,clockin_time:"8:00",clockout_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-21'},
        {employee_id: 1,clockin_time:"8:00",clockout_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-22'},
        {employee_id: 1,clockout_time:"14:00",clockin_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-22'},
        {employee_id: 1,clockout_time:"13:00",clockin_time:null,workingtime:10,nowtime:Date.now(),date:'2018-7-23'},
