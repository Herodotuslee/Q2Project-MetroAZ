  ...
  return knex('project').del()
    .then(function () {
      ...
      return knex('project').insert([
        ...
        {name: 'Arizona State Route 303', address: 'West Valley, Arizona', description:'Loop 303 Outfall drainage system was constructed for Maricopa County Flood Control District in 2015. It was a 4.5 mile concrete reinforced channel which also included thirteen box culverts, storm draining improvements spanning from Southern Ave. to Van Buren Rd. along the 303 corridor.', img_url: '/images/303.jpeg'},
        {name: 'Tanger Outlets', address: '6800 N 95th Ave, Glendale, AZ 85305', description:'Shopping-mall chain featuring a variety of brand-name & designer outlet stores.', img_url:'/images/mall.jpeg'},
      ]);
    });
};
